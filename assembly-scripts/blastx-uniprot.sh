...
########################
# -outfmt 5
# to call: sbatch blastx-uniprot.sh input.fa databasepath
...
/home/groups/spalumbi/programs/ncbi-blast-2.8.1+/bin/blastx -db $2 -query $1 -out $1.blast.out -evalue 0.001 -max_hsps 1 -num_threads 6 -outfmt 5
